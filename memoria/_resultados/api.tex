...
Estos \dfnp{endpoints} se usan a través de la interfaz como veremos más adelante. La excepción es los de CPU, memoria y procesos. Estos últimos fueron utlizados durante la fase de depurado del proyecto para mejorar el rendimiento y el uso de memoria de Krptkn pero no en su versión final.
